...
Защита проверена практически: ошибка Ruff `F401` (неиспользуемый импорт) приводит к падению `lint` и `Required CI`, после чего ruleset `Protect main` блокирует merge до исправления.
